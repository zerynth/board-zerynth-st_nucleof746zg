...
#define VM_OTA_RECORD 0x08004000
#define VM_OTA_VM_ADDR(idx) ( ((idx)%(VM_OTA_MAX_VM)) ? (0x08040000):(0x8000000))
#define VM_OTA_BYTECODE(idx) ( ((idx)%(VM_OTA_MAX_BC)) ? (0x08060000):(0x08020000))
